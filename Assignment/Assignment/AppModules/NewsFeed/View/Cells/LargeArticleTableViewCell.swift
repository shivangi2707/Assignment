...
class LargeArticleTableViewCell: UITableViewCell {
    ...
    // Configure Method
    func configureLargeArticleCell(data: NewsFeedItem?) {
        self.titleLabel.text = data?.title
        self.itemImageView.setImageFromURL(urlString: data?.enclosure?.link)
